    ...
    <div class="box_regist"></div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h5 class="panel-title">編集内容確認</h5>
            </div>
            <div class="panel-body">
                ...
                <input type="submit" class="btn btn-primary" name="action" value="更新する">
...
<?php endif; ?>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-2 form-inline">
                            <input type="text" class="form-control" name="title" value="<?php if( isset($_POST['title']) ){ echo $_POST['title']; }else { echo $title;}  ?>" size="80">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-2 form-inline">
                            <input type="text" class="form-control" name="name" value="<?php if( isset($_POST['name']) ){ echo $_POST['name']; }else { echo $name;}  ?>" size="40">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    本文<br>
                    <textarea class="form-control" name="body" rows="10"><?php if( isset($_POST['body']) ){ echo $_POST['body']; }else { echo $body;}  ?></textarea><br>
                </div>
                <button type="button" class="btn btn-default" onclick="history.back()" style="margin-right:10px;">戻る</button>
                <input type="submit" class="btn btn-primary" name="confirm" value="編集内容を確認する">
                </div>
                </form>
            </div>
        </div>
