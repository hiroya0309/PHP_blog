...
$start = ($page -1) * 5;
//最新記事から5記事ごと表示
$query = "SELECT * , LEFT(body,250)as content FROM posts ORDER BY id DESC LIMIT {$start},5";
?>
...
if($result = $mysqli->query($query)) {
  ...
  <br>
  <h4><label>記事はありません。</label></h4>
<?php } ?>
<!-- ページング -->
<p>
  <?php if ($page > 1) : ?>
    <a href="home.php?page=<?php echo ($page - 1); ?>">前のページ </a>
  <?php endif; ?>

  <?php if ($page < $maxPage) : ?>
    <a href="home.php?page=<?php echo ($page + 1); ?>"> 次のページ</a>
  <?php endif; ?>
</p>
</div>
<!-- サイドメニュー -->
